export default function ProblemSection() {
  return (
    <section id="problema" className="scroll-mt-20 bg-white py-16 sm:py-24">
      <div className="mx-auto max-w-6xl px-6">
        <h2 className="max-w-[20ch] text-balance text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
