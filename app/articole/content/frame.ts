 ...
 * benzii: sunt ale ramei, nu ale articolului. Rama e lege pentru fiecare
 * articol, fără excepție (articolele de dinaintea ei au fost șterse de operator,
 * 2026-09-05). Verificarea ramei trăiește tot aici (`frameErrors`); schema o apelează.
