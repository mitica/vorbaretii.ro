...
export const STYLES: Record<string, string> = {
  ...
  "fire-de-nisip":
    "Sand-art illustration, bright and cheerful: the entire scene formed from loose grains of colored sand and fine powder poured on a flat surface, visibly granular texture everywhere, soft powdery edges and sprinkled gradients that look like a single breath of air would scatter them, delicate trails of stray grains around every shape. Sunny warm mood and a vivid palette — fresh blues, spring greens, warm reds, golden yellows on a light cream ground. Faces simple and naturally proportioned, traced in the same loose-sand language as the rest of the scene — no Disney-style big-eyed cartoon faces, no cute doll faces. Clearly readable for children — never gloomy, never washed-out.",
};
