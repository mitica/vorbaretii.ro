...
export const STYLES: Record<string, string> = {
  ...
  "vorbaretii":
    "Flat vector illustration in the Vorbăreții house style, bright and playful: every figure and object built from a few bold geometric shapes — thick chunky rounded forms, one continuous silhouette per character, zero texture, no outlines, solid colour fills with soft same-hue shading, silhouettes readable even at icon size; clean uncluttered background with generous negative space. Faces simple and calm: large round friendly eyes with tiny highlights, small brows, small mouths — never Disney-glossy, never doll-like. Palette of the house: deep Voroneț blue (#3E4394) is the PRIMARY brand colour — present in every image on a few key elements (a garment, an object, the shadows), never as a wash over the whole scene; everything else keeps its natural colour in the same flat geometric language: green grass and trees, warm brown wood, sandy stone, skin tones, white snow, red where things are red; sky blue (#81C5F4) for skies and light areas; a single magenta-pink accent (#FF66A6) used sparingly; golden yellow (#FFC526) for warm touches; all on a light cream ground (#FBF3E4) with soft blue-tinted shadows. Slightly mischievous mood. Clearly readable for children — never gloomy, never washed-out.",
  "vector-plat":
